        ...
        <CardWrapper>
          ...
          >
            <CardItemWrapper>
              ...
              <CardContentImage backgroundUrl="assets/img/traning_1.jpg" />
          ...
          >
            <CardItemWrapper>
              ...
              <CardContentImage backgroundUrl="assets/img/traning_2.jpg" />
              <CardContentAbsoluteBoxWrapper>
                수료 후 현장 투입,
                <br />
                현직 멘토와 함께하는 일경험
...
const Wrapper = styled.div`
  width: 100%;
  background: center center / cover url("assets/img/bg_about_training.jpg");
`;
